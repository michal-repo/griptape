...
@define
class AmazonBedrockStableDiffusionImageGenerationDriver(BaseImageGenerationDriver, BaseImageModificationDriver):
    ...
    init_image_strength: Optional[float] = field(default=0.35, kw_only=True)
    ...
    def try_modify_image(
        ...
        request = {
            "text_prompts": text_prompts,
            "init_image": input_image.base64,
            "image_strength": self.init_image_strength,
            "cfg_scale": self.cfg_scale,
            "style_preset": self.style_preset,
            "clip_guidance_preset": self.clip_guidance_preset,
            "sampler": self.sampler,
        ...
        if mask_image is not None:
            ...
            request["mask_source"] = "MASK_IMAGE_BLACK"
    ...
    def try_inpaint_image(
        self,
        init_image: ImageArtifact,
        ...
        request = {
            "text_prompts": text_prompts,
            "init_image": init_image.base64,
            "mask_image": mask_image.base64,
